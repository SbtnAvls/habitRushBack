...
describe('Daily Evaluation Service', () => {
  ...
  describe('runDailyEvaluation', () => {
    it('should run evaluation successfully', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('Starting daily evaluation')
      );
      expect(console.log).toHaveBeenCalledWith(
    ...
    it('should not run twice on the same day', async () => {
      ...
      expect(habitEvaluationService.evaluateAllUsersDailyHabits).toHaveBeenCalledTimes(1);
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('Already executed today')
      );
    });
    ...
    it('should log statistics correctly', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('Total users evaluated: 3')
      );
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('Users with missed habits: 2')
      );
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('Total lives lost: 3')
      );
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('Total habits disabled: 3')
      );
    });
    ...
    it('should log users with no lives', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('users have no lives left')
      );
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('User user-dead')
      );
    });
  ...
  describe('startDailyAt0005', () => {
    it('should schedule first execution at 00:05', () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('Scheduling first execution in')
      );
    });
  ...
  describe('integration tests', () => {
    it('should handle multiple users with different outcomes', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('1 users have no lives left')
      );
    });
    ...
    it('should update lastExecutionDate after successful run', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining(`Already executed today (${today})`)
      );
    });
  });
});